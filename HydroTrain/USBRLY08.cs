...
public class USBRLY08 : Form
{
	...
	public bool CleanWaterEmpty;

	public bool CirculationPumpError;

	public bool UVCLamp;

	public bool CleanCirculation;

	public bool Heater;

	public byte CirculationErrorCount;

	private static bool Circulation;
	...
	private void InitializeComponent()
	{
		...
		this.MessageBox.Location = new System.Drawing.Point(111, 401);
		this.MessageBox.Multiline = true;
		this.MessageBox.Name = "MessageBox";
		this.MessageBox.Size = new System.Drawing.Size(225, 33);
		this.MessageBox.TabIndex = 269;
		this.SerialAddress.FormattingEnabled = true;
		this.SerialAddress.Location = new System.Drawing.Point(17, 134);
		this.SerialAddress.Name = "SerialAddress";
		this.SerialAddress.Size = new System.Drawing.Size(76, 173);
		this.SerialAddress.TabIndex = 268;
		this.OKVolts.Location = new System.Drawing.Point(10, 416);
		this.OKVolts.Name = "OKVolts";
		this.OKVolts.Size = new System.Drawing.Size(52, 20);
		this.OKVolts.TabIndex = 267;
		...
		this.CommsResetInd.Location = new System.Drawing.Point(41, 332);
		this.CommsResetInd.Name = "CommsResetInd";
		this.CommsResetInd.Size = new System.Drawing.Size(44, 20);
		this.CommsResetInd.TabIndex = 265;
		...
		this.TitleName.Location = new System.Drawing.Point(13, 12);
		this.TitleName.Name = "TitleName";
		this.TitleName.Size = new System.Drawing.Size(38, 20);
		this.TitleName.TabIndex = 264;
		...
		this.Label14.Location = new System.Drawing.Point(112, 164);
		...
		this.ErrorReporting.Location = new System.Drawing.Point(274, 25);
		this.ErrorReporting.Multiline = true;
		this.ErrorReporting.Name = "ErrorReporting";
		this.ErrorReporting.Size = new System.Drawing.Size(106, 72);
		this.ErrorReporting.TabIndex = 236;
		this.ErrorReporting.Text = "No Error";
		this.WriteDataTM.Enabled = true;
		this.WriteDataTM.Interval = 75;
		this.SoftwareVer.Location = new System.Drawing.Point(194, 63);
		this.SoftwareVer.Name = "SoftwareVer";
		this.SoftwareVer.Size = new System.Drawing.Size(54, 20);
		this.SoftwareVer.TabIndex = 270;
		...
		this.ComboBox_comport.Location = new System.Drawing.Point(12, 35);
		this.ComboBox_comport.Name = "ComboBox_comport";
		this.ComboBox_comport.Size = new System.Drawing.Size(167, 32);
		this.ComboBox_comport.TabIndex = 272;
		this.ComboBox_comport.Text = "Select COM port";
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(474, 481);
	...
	public void SerialPortOpen()
	{
		...
		{
			Port = Interaction.GetSetting("Health", "Setup", "Port" + base.Name + "B", "0");
			if (Conversions.ToInteger(Port) > 0)
			{
				Interaction.SaveSetting("Health", "Setup", "Port" + base.Name, Port);
				Interaction.SaveSetting("Health", "Setup", "Port" + base.Name + "B", "0");
			}
		}
		if (Conversion.Val(Port) > 0.0)
		{
	...
	{
		if ((Conversion.Val(Interaction.GetSetting("Health", "Setup", "Port" + base.Name, "0")) > 0.0) | (Conversion.Val(Interaction.GetSetting("Health", "Setup", "Port" + base.Name + "B", "0")) > 0.0))
		{
			Hide();
			SerialPortOpen();
		}
	...
	private void Board_Activated(object sender, EventArgs e)
	{
		...
		Port = "0";
		if (Conversions.ToInteger(Interaction.GetSetting("Health", "Setup", "Port" + base.Name, "0")) > 0)
		{
			Port = Interaction.GetSetting("Health", "Setup", "Port" + base.Name, "0");
			AppendTextBox(CommsNoBoard, Port);
		}
	...
	{
		if ((Conversion.Val(CommsResetInd.Text) == 10.0) | Display.RLY08Startup)
		{
	...
	public void GetAck()
	{
		...
		if (Operators.CompareString(ReturnType, "NoReturn", TextCompare: false) != 0)
		{
			...
			case "Outputs":
			{
				byte b = ((!(Conversion.Val(textIn) > 255.0)) ? Conversions.ToByte(textIn) : byte.MaxValue);
				DataReceivedBoard = "";
				byte b2 = 0;
				do
				{
					checked
					{
						if ((b & (byte)Math.Round(Math.Pow(2.0, unchecked((int)b2)))) != 0)
						{
							...
							if (MotorSwitch[1] | MotorSwitch[2])
							{
	...
	private void MotorControlOp()
	{
		...
		checked
		{
			...
			if (MotorIndex == 5)
			{
				...
				else if ((!Display.CineOn & MotorSwitch[MotorIndex]) | (Display.CineOn & !MotorSwitch[MotorIndex]))
				{
					MotorOnOff = Display.CineOn;
					MotorSent = true;
				}
				if (!MotorSent)
				{
			...
			if (MotorIndex == 6)
			{
				...
				else if ((!Display.LightsOn & MotorSwitch[MotorIndex]) | (Display.LightsOn & !MotorSwitch[MotorIndex]))
				{
					MotorOnOff = Display.LightsOn;
					MotorSent = true;
				}
				if (!MotorSent)
				{
			...
			else if ((!MyProject.Forms.Display.ADC2Stop & MotorSwitch[MotorIndex]) | (MyProject.Forms.Display.ADC2Stop & !MotorSwitch[MotorIndex]))
			{
				MotorOnOff = MyProject.Forms.Display.ADC2Stop;
				MotorSent = true;
			}
			if (!MotorSent)
			{
